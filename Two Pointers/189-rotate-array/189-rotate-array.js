...
const rotate = function (nums, k) {
  ...
  // What if we have k = 100 and array length is 7, then we will not rotate it 100 times.
  // It simply means we will rotate only 100 % = 2 times => [6,7,1,2,3,4,5]
  ...
  k = -1 => k = 6.
  So, what it represents is that add the -ve value to the length of array.*/
