...
MinStack.prototype.pop = function () {
  ...
  // what if our stacks are:
  // stack: [-2, 0, -3, -1]
  // minStack: [-2, -2, -3, -3]
  // We pop different values (-1 and -3) from our stacks but that's fine since
  // minStack doesn't care about -1, just the min values. And the second last value is also
  // -3
